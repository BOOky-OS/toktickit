...
| ActionTakenRevision | Int PK; actionId FK RESTRICT; actorId FK RESTRICT; version Int; event CREATE/EDIT/STATUS; JSON snapshot of all current action fields; createdAt; UNIQUE(actionId,version) |
