...
was checked on 2026-09-10. Lab 3 reviews still need to happen.
...
Read the contract's permission matrix, status rules, password/session decisions,
migration/seed safety, planned tests and the main gate. Give specific changes
