...
- ทุกครั้งที่ทำงานเสร็จ พร้อมขอรีวิว แก้ feedback เสร็จ หรือได้รับแจ้งว่าเพื่อน merge แล้ว ให้แนบร่างคอมเมนต์ที่เกี่ยวข้องในคำตอบทันทีโดยไม่ต้องรอผู้ใช้ขอ กฎนี้ใช้กับทุก Lab และการทำงานรอบถัดไป
- ร่างเป็นภาษาอังกฤษตามรูปแบบ PR เดิม พร้อมคำอธิบายไทยว่าใครควรโพสต์ ที่ PR/thread ใด และใช้เมื่อใด ให้ข้อความพร้อมคัดลอกที่อ้างอิงงานจริง
- เมื่อ PR พร้อมรีวิว ให้เตรียมข้อความสำหรับผู้รีวิวหลังตรวจจริง คำตอบของผู้เขียนหลัง Approve และคำตอบหลังเพื่อน merge โดยระบุเงื่อนไขแต่ละช่วงชัดเจน ร่างล่วงหน้าไม่ใช่หลักฐานว่า Approve หรือ merge แล้ว ผู้รีวิวต้องปรับข้อความให้ตรงกับสิ่งที่ตนตรวจและ verdict จริง
- หลังแก้ feedback ให้ร่างคำตอบตรงประเด็นพร้อม commit/ผลตรวจที่เกี่ยวข้อง หลังได้รับแจ้งว่า merge แล้ว ให้ตรวจ GitHub ก่อนร่างคำตอบหลัง merge โดยใช้ผู้ merge, commit และสถานะ Issue/Project ที่ยืนยันได้ ห้ามอ้างว่างานถัดไปเสร็จแล้ว
- หากผู้ใช้โพสต์ข้อความของช่วงนั้นแล้ว ให้แจ้งว่าตรวจพบคำตอบแล้วและระบุขั้นตอนถัดไป ไม่ขอให้โพสต์ซ้ำ หากไม่มีคอมเมนต์ใหม่ที่จำเป็น ให้บอกเหตุผลสั้น ๆ
...
แนบร่างคอมเมนต์ตามจังหวะงานในข้อ 6 ทุกครั้งโดยไม่รอให้ผู้ใช้ขอ รวมถึงคำตอบหลังเพื่อน merge
...
ทุกครั้งที่งานเสร็จให้แนบร่างคอมเมนต์พร้อมใช้ตามจังหวะรีวิว รวมคำตอบหลังเพื่อน merge โดยไม่ต้องรอฉันขอ
